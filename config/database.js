...
const config = require("./db_config.json")[process.env.NODE_ENV || "development"];

const mysql_db = config.mysql;
const sequelize = new Sequelize(mysql_db.database, mysql_db.username, mysql_db.password, {
  host: mysql_db.host,
